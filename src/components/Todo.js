    ...
    <Draggable key={todo.id} draggableId={todo.id} index={index}>
      {(provided) => (
        <div
          ...
          id={todo.id}
          key={todo.id}
          className="flex flex-row items-center justify-between overflow-x-hidden px-5 py-4 border-solid border-b border-light-veryLightGrayishBlue group mobilePlus:pt-5 mobilePlus:px-6"
        >
